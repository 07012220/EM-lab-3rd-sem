...
loglog(s,rhoa_anISO,"r",s,rhoa_h,"b",s,rhoa_v,"k"); %plotting the rho vs s curve in log-log scale
legend('Anisotropic case','horizontal anisotropy','vertical anisotropy');
